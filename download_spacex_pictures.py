...
def fetch_spacex_launches(launch_id, args_pathargs_path):
    ...
    for number, link in enumerate(space_photo_links, start=1):
        ...
        spacex_params = {}
        helper_script.download_picture(spacex_response, link, spacex_params, args_pathargs_path, spacex_filename)
...
def main():
    ...
    try:
        fetch_spacex_launches(launch_id, args_pathargs_path)
